...
def config_table() -> Panel:
    ...
    table.add_row("IS_REMOVE_FILES", ' [green]On[/green]' if config.IS_REMOVE_FILES == 1 or config.IS_REMOVE_FILES == '1' else ' [red]Off[/red]')
    table.add_row("REMOVE_FILE_AFTER_MINS", " "+str(config.REMOVE_FILE_AFTER_MINS))
    table.add_row("IS_ENABLED_REELS_SCRAPER", ' [green]On[/green]' if  config.IS_ENABLED_REELS_SCRAPER == 1 or config.IS_ENABLED_REELS_SCRAPER == "1"  else ' [red]Off[/red]')
    table.add_row("IS_ENABLED_AUTO_POSTER", ' [green]On[/green]' if config.IS_ENABLED_AUTO_POSTER == 1 or config.IS_ENABLED_AUTO_POSTER == "1" else ' [red]Off[/red]')
